...
//		System.out.println(stream);
	...
	@Test
	public void multiple_errors3() throws SyntaxException {
		System.out.println("***********\nmultiple_errors3                                                                                    ");
		String input = "class A {def C=&1; S=&4; T=-4;R=5  } ";
		System.out.println(input);
		parseIncorrectInput(input, AND,AND, RCURLY );
	}
	
	@Test
	public void multiple_errors4() throws SyntaxException {
		System.out.println("***********\nmultiple_errors4                                                                                    ");
		String input = "class A {def C={S:string,P:int->x=4;y=8;z!=8;}; S=&4; T=-4;R=5  } ";
		System.out.println(input);
		parseIncorrectInput(input, NOTEQUAL,AND, RCURLY );
	}
