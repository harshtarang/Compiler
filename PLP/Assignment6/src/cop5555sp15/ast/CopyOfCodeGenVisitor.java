...
public class CopyOfCodeGenVisitor implements ASTVisitor, Opcodes, TypeConstants {
	...
	public Object visitAssignmentStatement(AssignmentStatement assignmentStatement, Object arg) throws Exception 
	{
		...
		if(assignmentStatement.lvalue instanceof ExpressionLValue)
		{
			...
			ExpressionLValue expr= (ExpressionLValue)assignmentStatement.lvalue;
			String ident=expr.identToken.getText();
			
			mv.visitFieldInsn(GETSTATIC, className, ident, "Ljava/util/ArrayList;");
			...
			expr.expression.visit(this, arg);
		...
		//	mv.visitMethodInsn(INVOKEVIRTUAL, "java/util/ArrayList", "get", "(I)Ljava/lang/Object;", false);
			...
			mv.visitFieldInsn(PUTSTATIC, className, ident, "Ljava/util/ArrayList;");
		...
		else
		{
			...
			assignmentStatement.lvalue.setType(type);//assignmentStatement.expression.expressionType);
	...
	@Override
	public Object visitExpressionLValue(ExpressionLValue expressionLValue,Object arg) throws Exception 
	{
		MethodVisitor mv = ((InheritedAttributes) arg).mv;
		if(expressionLValue.getType().equalsIgnoreCase("Ljava/util/List<I>;"))
		{
			
		  	mv.visitFieldInsn(GETSTATIC, className, expressionLValue.identToken.getText(), expressionLValue.getType());
	...
	public Object visitIdentExpression(IdentExpression identExpression,Object arg) throws Exception {
		...
		if(identExpression.expressionType.startsWith("Ljava/util/List"))
			identExpression.setType(emptyList);
	...
	public Object visitListExpression(ListExpression listExpression, Object arg) throws Exception 
	{
		...
		else if(listExpression.expressionType.startsWith("Ljava/util/List<"))
		{
			...
			//	else if(listExpression.expressionType.startsWith("Ljava/util/List<Ljava/util/List"))
				//	mv.visitMethodInsn(INVOKESTATIC, "java/util/ArrayList", "valueOf", "(I)Ljava/lang/Integer;",false);
	...
	private String removeLayer(String expressionType) 
	{
		String temp=expressionType.substring(16, expressionType.length()-3);
	...
	@Override
	public Object visitListOrMapElemExpression(ListOrMapElemExpression listOrMapElemExpression, Object arg)
			throws Exception 
	{
		MethodVisitor mv = ((InheritedAttributes) arg).mv;
			  	...
			  	mv.visitFieldInsn(GETSTATIC, className, listOrMapElemExpression.identToken.getText(), emptyList);
			 	listOrMapElemExpression.expression.visit(this, arg);
			
			 	mv.visitMethodInsn(INVOKEVIRTUAL, "java/util/ArrayList", "get", "(I)Ljava/lang/Object;", false);
			 	
			 	if(listOrMapElemExpression.expressionType.equalsIgnoreCase(intType))
			 	{
			 		mv.visitTypeInsn(CHECKCAST, "java/lang/Integer");
			 		mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Integer","intValue","()I",false);
			 	}
			 	else if(listOrMapElemExpression.expressionType.equalsIgnoreCase(booleanType))
			 	{
			 		mv.visitTypeInsn(CHECKCAST, "java/lang/Boolean");	
			 		mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Boolean","booleanValue","()Z",false);
			 	}
			 	else if(listOrMapElemExpression.expressionType.equalsIgnoreCase(stringType))
			 		mv.visitTypeInsn(CHECKCAST, "java/lang/String");
			 	else if(listOrMapElemExpression.expressionType.startsWith("Ljava/util/List<Ljava/util/List"))
			 	{
			 		mv.visitTypeInsn(CHECKCAST, "java/util/ArrayList");
			 		listOrMapElemExpression.setType(emptyList);
			 		//mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Integer","intValue","()I",false);
	...
	public Object visitUnaryExpression(UnaryExpression unaryExpression,Object arg) throws Exception 
	{
		...
		String type=unaryExpression.expression.expressionType;
		
		if(op.equals(Kind.MINUS))
		{
