...
public class TestSimpleParser {
	...
	@Test
	public void incorrectDeclaration() throws SyntaxException {
	...
	@Test
	public void almostEmptyIncorrect2() throws SyntaxException {
		System.out.println("Almost empty 2");
		String input="class A {&} ";
		System.out.println(input);
	...
	@Test
	public void incorrectWhile() throws SyntaxException {
		System.out.println("Incorrect while");
		String input="class A {while(1..2){};} ";
		System.out.println(input);
		parseIncorrectInput(input,RANGE);		
	}

	@Test
	public void correctClosure() throws SyntaxException {
		System.out.println("Correct Closure");
		String input="class A {def C={->;;;};\n while(x){};}";
		System.out.println(input);
		parseCorrectInput(input);
	}
	...
	@Test
	public void correctList() throws SyntaxException {
		System.out.println("Correct List");
		String input="class A {print a({b:@[int]->;while(x){};;});}";
		System.out.println(input);
		parseCorrectInput(input);
	}
	
	@Test
	public void correctStatement() throws SyntaxException {
		System.out.println("Correct Statement");
		String input="class A {%{->while(x){};};}";
		System.out.println(input);
		parseCorrectInput(input);
	}
